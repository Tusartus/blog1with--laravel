...
class PostController extends Controller
{
  ...
  return redirect('/home')->with('response', 'Post added Successfuly');
    }
//view signgle post per id
...
return redirect('/home')->with('response', 'Post updated  Successfuly');
...
public function deletePost($post_id){
  Post::where('id', $post_id)
   ->delete();
   return redirect('/home')->with('response', 'Post deleted Successfuly');
}
...
public function comment(Request $request, $post_id){
     ...
     $comment->save();
     return redirect("/view/{$post_id}")->with('response', 'Comment added  Successfuly');
