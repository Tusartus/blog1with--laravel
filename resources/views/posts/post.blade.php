                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/addPost')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group row {{ $errors->has('post_title') ? 'has_error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="post_title" type="text" class="form-control" name="post_title" value="{{ old('post_title') }}" required>
                      ...
                      <div class="form-group row {{ $errors->has('post_body') ? 'has_error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <textarea id="post_body" type="text" class="form-control" rows="5"  name="post_body" value="{{ old('post_body') }}" required></textarea>
